...
def main():
    ...
    print '[INFO, time: %s] Fitting %s ...' % (time.strftime('%H:%M:%S'), 'ADA Boosted Tree - Max Depth 20')
    clf = AdaBoostClassifier(DecisionTreeClassifier(max_depth=20), n_estimators=600, learning_rate=1.5, algorithm="SAMME")
